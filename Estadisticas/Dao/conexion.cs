...
namespace Estadisticas.Dao
{
    public class conexion
    {
        ...
        public NpgsqlConnection Crear_conexion()
        {
            ...
            String config = "Server=201.180.78.34;Port=15432;Database=estadisticas_clinica;User Id=sis-clinica;Password=ElCapo1072;"; // "Server=" + Program.properties.servidor + ";Port=" + Program.properties.puerto + ";Database=" + Program.properties.catalogo + ";User Id=postgres;Password=elcapo9242; Timeout=10;"; //Config();
